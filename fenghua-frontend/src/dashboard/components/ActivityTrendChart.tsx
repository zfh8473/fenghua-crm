 ...
 * 
 * Displays buyer activity trend using Recharts
 * All custom code is proprietary and not open source.
 */

import React, { Suspense, lazy } from 'react';
import { ActivityTrendItem } from '../services/buyer-analysis.service';
...
export const ActivityTrendChart: React.FC<ActivityTrendChartProps> = ({
  ...
  const chartData = data.map((item) => ({
    name: item.period,
    averageActivityLevel: item.averageActivityLevel,
