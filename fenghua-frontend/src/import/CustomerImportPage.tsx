 ...
 * 
 * Main page for customer data bulk import
...
export const CustomerImportPage: React.FC = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
          ...
          <Card title="步骤 1: 上传文件" variant="default">
            <div className="space-y-monday-4">
              <p className="text-monday-sm text-monday-text-secondary">
                请上传包含客户数据的 Excel 或 CSV 文件。文件大小不能超过 50MB。
              </p>
              <ImportFileUpload
      ...
      case 'importing':
        return taskId ? (
          <ImportProgress taskId={taskId} onComplete={handleImportComplete} />
        ) : null;
